...
//            totalReduce.stringValue = String.localizedStringWithFormat(NSLocalizedString("tasks desc", comment: "tasks desc"), TPClient.sharedClient.finishTasksCount, Formator.formatSize(totalRecudeSize), Formator.formatRate(totalRecudeSize / totalSize))
			...
			totalReduce.stringValue = String.localizedStringWithFormat(NSLocalizedString("tasks desc with total", comment: "tasks desc with total"), TPClient.sharedClient.finishTasksCount,TPClient.sharedClient.queue.size(), Formator.formatSize(totalRecudeSize), Formator.formatRate(totalRecudeSize / totalSize))
	...
	func draggingFileAccept(_ files:Array<URL>) {
        ...
        totalReduce.stringValue = String.localizedStringWithFormat(NSLocalizedString("tasks desc with total", comment: "tasks desc with total"), 0,TPClient.sharedClient.queue.size(),Formator.formatSize(0), Formator.formatRate(0))
	}
